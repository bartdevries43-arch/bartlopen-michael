...
const CACHE = "runcoach-michael-v1-c2";
const ASSETS = ["./","./index.html","./styles.css?v=1-c2","./app.js?v=1-c2","./coach.jpg","./coach-logo.png","./bartlopen-runcoach.png","./icon-192.png","./icon-512.png","./apple-touch-icon.png","./manifest.json"];
