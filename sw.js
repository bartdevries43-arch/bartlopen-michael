...
const CACHE = "runcoach-michael-v1";
const ASSETS = ["./","./index.html","./styles.css?v=1","./app.js?v=1","./coach.jpg","./coach-logo.png","./bartlopen-runcoach.png","./icon-192.png","./icon-512.png","./apple-touch-icon.png","./manifest.json"];
